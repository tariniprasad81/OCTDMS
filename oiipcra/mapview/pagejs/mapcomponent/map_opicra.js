...
var vectorSource2 = new ol.source.Vector();
 var vectorSourceGP = new ol.source.Vector()
    ...
    const ofarisurl = "https://mapserver.odisha4kgeo.in/geoserver/ofaris/wms";
        ...
        const sampadgcfofaris="https://mapserver.odisha4kgeo.in/geoserver/oiipcra/wms";//"https://odishasampad.orsac.gov.in/geoserver/ofaris/wms";
...
//    });
   let groupNaturalResources = new ol.layer.Group({
    ...
    olMap = new ol.Map({
        ...
        layers: [groupbasemap, groupgoogle,wmslayerwaterbody,ofaris_oiipcra_mip, groupNaturalResources,groupinfrastructurenetwork,groupinfrastructuresocialothers, groupAdmin],
        view: new ol.View({
