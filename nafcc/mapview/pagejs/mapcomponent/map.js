...
var vectorSource2 = new ol.source.Vector();
 var vectorSourceGP = new ol.source.Vector()
    ...
    let state_bnd_4k = new ol.layer.Image({
        name: 'State Boundary',
...
//layers
    ...
    let groupcoast= new ol.layer.Group({
            name: 'Coast',
            layers: [coast_htl,coast_crz],
            visible: false
        });
   ...
   let groupNaturalResources = new ol.layer.Group({
            name: 'NR Layers',
            layers: [wmslayer_soiltexture,wmslayerSoil, wmslayergeomorphology,wmslayerLulc_nris_50k,ofaris_waterbody,wmslayerdrain],
            visible: true
    });
    ...
    olMap = new ol.Map({
        ...
        layers: [groupbasemap, groupgoogle,groupcoast,groupNaturalResources,groupinfrastructurenetwork,groupinfrastructuresocialothers, groupFisheriesAssets, groupAdminFisheries],
        view: new ol.View({
...
//controls
    return {olMap,ofaris_notified_jetty_limit,state_bnd_4k,ofaris_waterbody,ofaris_multi_cyclone,ofaris_fish_landing_center,ofaris_village_boundary,wmslayer_soiltexture,layerlist}
