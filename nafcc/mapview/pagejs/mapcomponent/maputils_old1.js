...
jQuery(function($){
   ...
   parameterswb=getUrlVars();
    ...
    multipleassetinfo(parameters.data)
        ...
        {
        waterbodyinfo(parameterswb.zone,parameterswb.district,parameterswb.block,parameterswb.gramPanchayat);
        }
...
function waterbodyinfo(zoneid2,distid2,blockid2,gpid2){
